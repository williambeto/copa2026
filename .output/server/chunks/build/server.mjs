...
import { p as parseURL, e as encodePath, i as decodePath, k as hasProtocol, l as isScriptProtocol, m as joinURL, w as withQuery, s as sanitizeStatusCode, n as getContext, $ as $fetch, o as defu, q as createHooks, c as createError$1, r as executeAsync } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-VDJvWJqH.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-BNT-pOng.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DwXgJO-F.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DucQJgLW.mjs'));
