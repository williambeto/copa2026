...
import { u as useSeoMeta } from './v3-BLV6hdWT.mjs';
...
const _sfc_main$i = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const probabilityBars = [
      ...
      { label: "Fran\xE7a", value: 13.5, percent: 13.5 },
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div><p class="mt-4 text-xs text-gray-600 leading-relaxed" data-v-dc362f38> Nenhuma candidata possui probabilidade dominante. A Copa permanece aberta e imprevis\xEDvel. </p></div></div></div></div></div><div class="absolute bottom-0 left-0 right-0 h-40 bg-gradient-to-t from-navy-950 to-transparent pointer-events-none" aria-hidden="true" data-v-dc362f38></div></section>`);
    };
  }
});
...
const TEAMS = [
  {
    ...
    knockoutScore: 8.1,
    probabilityNote: 9.4,
    justification: "Melhor equil\xEDbrio geral entre ranking, forma, elenco e modelo de jogo.",
    category: "favorite",
    coach: "Luis de la Fuente",
    keyPlayers: ["Lamine Yamal", "Rodri", "Pedri", "Nico Williams", "Dani Olmo"],
    strengths: [
      "Lideran\xE7a no Elo",
      "Campe\xE3 da Euro 2024",
      "Elenco jovem",
      "Press\xE3o alta",
      "Controle de posse"
    ],
    risks: [
      "Depend\xEAncia criativa de Yamal",
      "Condi\xE7\xE3o f\xEDsica de jogadores importantes",
      "Poss\xEDvel dificuldade em partidas f\xEDsicas e ca\xF3ticas"
    ]
  },
  {
    id: "franca",
    ...
    knockoutScore: 9.7,
    probabilityNote: 9.1,
    justification: "Elenco mais profundo e forte experi\xEAncia em mata-mata.",
    category: "favorite",
    coach: "Didier Deschamps",
    keyPlayers: ["Kylian Mbapp\xE9", "Aur\xE9lien Tchouam\xE9ni", "Jules Kound\xE9", "Mike Maignan", "Ousmane Demb\xE9l\xE9"],
    strengths: [
      "Maior profundidade",
      "Mbapp\xE9",
      "Excelente capacidade f\xEDsica",
      "Deschamps",
      "Hist\xF3rico recente de finais"
    ],
    risks: [
      "Grupo dif\xEDcil",
  ...
  },
  {
    ...
    knockoutScore: 8.2,
    probabilityNote: 8.8,
    justification: "Enorme talento, mas ainda precisa provar controle em decis\xF5es.",
    category: "favorite",
    coach: "Thomas Tuchel",
    ...
    strengths: [
      ...
      "Rice",
      "Elenco profundo",
      "Eliminat\xF3rias dominantes"
    ],
    risks: [
      "Press\xE3o",
      "Hist\xF3rico de derrotas em decis\xF5es",
      "Adapta\xE7\xE3o de Tuchel"
    ]
  },
  {
    id: "argentina",
    ...
    knockoutScore: 9.8,
    probabilityNote: 8.7,
    justification: "Estabilidade, experi\xEAncia e lideran\xE7a competitiva.",
    category: "favorite",
    coach: "Lionel Scaloni",
    keyPlayers: ["Lionel Messi", "Enzo Fern\xE1ndez", "Cristian Romero", "Juli\xE1n \xC1lvarez", "Alexis Mac Allister"],
    strengths: [
      "Atual campe\xE3 mundial",
      "Campe\xE3 da Copa Am\xE9rica",
      "Scaloni",
      "Experi\xEAncia",
      "Lideran\xE7a emocional"
    ],
    risks: [
      "Idade dos l\xEDderes",
      "Condi\xE7\xE3o f\xEDsica de Messi",
  ...
  },
  {
    ...
    knockoutScore: 7.8,
    probabilityNote: 8.3,
    justification: "Elenco de elite, com d\xFAvidas sobre gest\xE3o t\xE1tica e hierarquia.",
    category: "contender",
    coach: "Roberto Mart\xEDnez",
    keyPlayers: ["Vitinha", "Bruno Fernandes", "Nuno Mendes", "R\xFAben Dias", "Rafael Le\xE3o"],
    strengths: [
      "Meio-campo de elite",
      "Profundidade t\xE9cnica",
      "Vitinha e Bruno Fernandes",
      "Nuno Mendes",
      "R\xFAben Dias"
    ],
    risks: [
      "Gest\xE3o de Cristiano Ronaldo",
      "Intensidade sem bola",
      "Decis\xF5es de Roberto Mart\xEDnez"
    ]
  },
  {
    id: "brasil",
    ...
    knockoutScore: 8.3,
    probabilityNote: 8,
    justification: "Teto alto, mas maior n\xFAmero de incertezas f\xEDsicas e estruturais.",
    category: "contender",
    coach: "Carlo Ancelotti",
    keyPlayers: ["Vin\xEDcius J\xFAnior", "Rodrygo", "Alisson", "\xC9der Milit\xE3o", "Est\xEAv\xE3o"],
    strengths: [
      "Vin\xEDcius J\xFAnior",
      "Talento ofensivo",
      "Carlo Ancelotti",
      "Tradi\xE7\xE3o",
    ...
    risks: [
      "Les\xF5es",
      "Idade m\xE9dia elevada",
      "Pouco tempo de trabalho",
      "Campanha irregular nas eliminat\xF3rias",
      "Depend\xEAncia de jogadores decisivos"
    ]
  },
  {
    id: "alemanha",
    ...
    knockoutScore: 7.3,
    probabilityNote: 7.6,
    justification: "Evolu\xE7\xE3o recente e talento, por\xE9m hist\xF3rico recente irregular.",
    category: "contender",
    coach: "Julian Nagelsmann",
    keyPlayers: ["Jamal Musiala", "Florian Wirtz", "Joshua Kimmich", "Antonio R\xFCdiger", "Kai Havertz"],
    strengths: [
      "Musiala e Wirtz",
      "Evolu\xE7\xE3o t\xE1tica com Nagelsmann",
      "Tradi\xE7\xE3o em Copas",
      "Elenco talentoso"
    ],
    risks: [
      "Hist\xF3rico recente irregular em Copas",
      "Defesa vulner\xE1vel",
  ...
  },
  {
    ...
    knockoutScore: 8.3,
    probabilityNote: 7.1,
    justification: "Defesa forte e experi\xEAncia, mas chaveamento potencialmente dif\xEDcil.",
    category: "contender",
    coach: "Ronald Koeman",
    keyPlayers: ["Virgil van Dijk", "Frenkie de Jong", "Xavi Simons", "Cody Gakpo", "Matthijs de Ligt"],
    strengths: [
      "Defesa com Van Dijk",
      "Meio-campo t\xE9cnico",
      "Experi\xEAncia em Copas"
    ],
    risks: [
      "Chaveamento potencialmente dif\xEDcil",
      "Inconsist\xEAncia ofensiva",
      "Depend\xEAncia de De Jong"
    ]
  },
  {
    id: "noruega",
    ...
    knockoutScore: 4.8,
    probabilityNote: 6.9,
    justification: "Ataque explosivo, por\xE9m pouca experi\xEAncia em grandes torneios.",
    category: "hidden",
    coach: "St\xE5le Solbakken",
    keyPlayers: ["Erling Haaland", "Martin \xD8degaard", "Alexander S\xF8rloth", "Antonio Nusa"],
    strengths: [
      "Haaland e \xD8degaard",
      "Ataque explosivo",
      "Boa forma recente"
    ],
    risks: [
      "Pouca experi\xEAncia em grandes torneios",
      "Elenco curto",
      "Depend\xEAncia de Haaland"
    ]
  },
  {
    id: "belgica",
    ...
    knockoutScore: 6.4,
    probabilityNote: 6.4,
    justification: "Grupo acess\xEDvel, mas for\xE7a real inferior \xE0 reputa\xE7\xE3o.",
    category: "contender",
    coach: "Rudi Garcia",
    keyPlayers: ["Kevin De Bruyne", "J\xE9r\xE9my Doku", "Amadou Onana", "Lo\xEFs Openda"],
    strengths: [
      "De Bruyne",
      "Grupo acess\xEDvel",
      "Talento ofensivo"
    ...
    risks: [
      "For\xE7a real inferior \xE0 reputa\xE7\xE3o",
      "Transi\xE7\xE3o geracional",
      "Defesa envelhecida"
    ]
  },
  {
    ...
    knockoutScore: 6.5,
    probabilityNote: 6.3,
    justification: "Excelente posi\xE7\xE3o no Elo e experi\xEAncia recente nos Estados Unidos.",
    category: "hidden",
    coach: "N\xE9stor Lorenzo",
    keyPlayers: ["Luis D\xEDaz", "James Rodr\xEDguez", "Jhon Dur\xE1n", "Davinson S\xE1nchez"],
    strengths: [
      "Boa posi\xE7\xE3o no Elo",
      "Luis D\xEDaz",
      "Experi\xEAncia nos EUA"
    ],
    risks: [
      "Idade m\xE9dia elevada",
      "Elenco limitado em algumas posi\xE7\xF5es",
      "Inconsist\xEAncia defensiva"
    ]
  },
  {
    id: "uruguai",
    ...
    knockoutScore: 7.5,
    probabilityNote: 5.9,
    justification: "Tradi\xE7\xE3o em Copas e elenco competitivo, mas momento irregular.",
    category: "underdog",
    coach: "Marcelo Bielsa",
    keyPlayers: ["Federico Valverde", "Darwin N\xFA\xF1ez", "Ronald Ara\xFAjo", "Manuel Ugarte"],
    strengths: [
      "Bielsa",
      "Valverde",
      "Tradi\xE7\xE3o em Copas"
    ...
    risks: [
      "Momento irregular",
      "Chaveamento dif\xEDcil",
      "Depend\xEAncia t\xE1tica"
    ]
  },
  {
    id: "marrocos",
    ...
    knockoutScore: 7.5,
    probabilityNote: 5.8,
    justification: "Elenco jovem e experi\xEAncia da semifinal de 2022.",
    category: "hidden",
    coach: "Walid Regragui",
    keyPlayers: ["Achraf Hakimi", "Brahim D\xEDaz", "Noussair Mazraoui", "Azzedine Ounahi"],
    strengths: [
      "Elenco jovem",
      "Experi\xEAncia de 2022",
      "Hakimi"
    ],
    risks: [
      "Pouca profundidade",
      "Grupo potencialmente dif\xEDcil",
      "Inconsist\xEAncia ofensiva"
    ]
  }
];
const PROBABILITY_RANKING = [
  { team: "Espanha", probability: 16.5, flag: "\u{1F1EA}\u{1F1F8}" },
  { team: "Fran\xE7a", probability: 13.5, flag: "\u{1F1EB}\u{1F1F7}" },
  { team: "Inglaterra", probability: 11.5, flag: "\u{1F3F4}\u{E0067}\u{E0062}\u{E0065}\u{E006E}\u{E0067}\u{E007F}" },
  { team: "Argentina", probability: 11, flag: "\u{1F1E6}\u{1F1F7}" },
  { team: "Portugal", probability: 8, flag: "\u{1F1F5}\u{1F1F9}" },
  { team: "Brasil", probability: 7.5, flag: "\u{1F1E7}\u{1F1F7}" },
  { team: "Alemanha", probability: 5.5, flag: "\u{1F1E9}\u{1F1EA}" },
  { team: "Holanda", probability: 4, flag: "\u{1F1F3}\u{1F1F1}" },
  { team: "Noruega", probability: 3.8, flag: "\u{1F1F3}\u{1F1F4}" },
  { team: "B\xE9lgica", probability: 2.8, flag: "\u{1F1E7}\u{1F1EA}" },
  { team: "Outras sele\xE7\xF5es", probability: 15.9, flag: "\u{1F30D}" }
];
const EXECUTIVE_CARDS = [
  { label: "Favorita atual", team: "Espanha", value: "16,5%", flag: "\u{1F1EA}\u{1F1F8}" },
  { label: "Maior profundidade de elenco", team: "Fran\xE7a", flag: "\u{1F1EB}\u{1F1F7}" },
  { label: "Melhor estabilidade competitiva", team: "Argentina", flag: "\u{1F1E6}\u{1F1F7}" },
  { label: "Elenco com maior teto", team: "Inglaterra", flag: "\u{1F3F4}\u{E0067}\u{E0062}\u{E0065}\u{E006E}\u{E0067}\u{E007F}" },
  { label: "Candidata com mais incertezas", team: "Brasil", flag: "\u{1F1E7}\u{1F1F7}" },
  { label: "Sele\xE7\xE3o oculta mais perigosa", team: "Noruega", flag: "\u{1F1F3}\u{1F1F4}" }
];
const GROUPS = {
  espanha: {
    opponents: ["Uruguai", "Ar\xE1bia Saudita", "Cabo Verde"],
    difficulty: "Moderado",
  ...
  franca: {
    ...
    difficulty: "Muito dif\xEDcil",
    difficultyLabel: "Muito dif\xEDcil",
    firstPlaceChance: 0.55,
    knockoutImpact: "Primeiro lugar \xE9 crucial para evitar um caminho com m\xFAltiplas favoritas."
  },
  argentina: {
    opponents: ["Arg\xE9lia", "\xC1ustria", "Jord\xE2nia"],
    difficulty: "Favor\xE1vel",
    difficultyLabel: "Favor\xE1vel",
    firstPlaceChance: 0.85,
    knockoutImpact: "Grupo favor\xE1vel permite rodar elenco e chegar em boas condi\xE7\xF5es."
  },
  inglaterra: {
    opponents: ["Cro\xE1cia", "Gana", "Panam\xE1"],
    difficulty: "Moderado",
    difficultyLabel: "Moderado",
    firstPlaceChance: 0.7,
    knockoutImpact: "Evitar segundo lugar \xE9 importante para n\xE3o cruzar com favoritas nas oitavas."
  },
  portugal: {
    opponents: ["Rep\xFAblica Democr\xE1tica do Congo", "Uzbequist\xE3o", "Col\xF4mbia"],
    difficulty: "Moderado",
    difficultyLabel: "Moderado",
    firstPlaceChance: 0.65,
    knockoutImpact: "A Col\xF4mbia no grupo pode complicar a disputa pelo primeiro lugar."
  },
  brasil: {
    opponents: ["Marrocos", "Jap\xE3o", "Nova Zel\xE2ndia"],
    difficulty: "Perigoso na estreia",
    difficultyLabel: "Perigoso na estreia",
    firstPlaceChance: 0.55,
    knockoutImpact: "Marrocos na estreia \xE9 um teste dif\xEDcil; segundo lugar pode levar ao lado perigoso da chave."
  }
};
const KNOCKOUT_PATHS = {
  espanha: [
    { scenario: "favorable", description: "1\xBA do grupo \u2192 advers\xE1rios de grupos acess\xEDveis nas oitavas e quartas", potentialOpponents: ["Sele\xE7\xE3o do Grupo C (2\xBA)", "Sele\xE7\xE3o do Grupo A/B"], difficulty: 3 },
    { scenario: "likely", description: "1\xBA do grupo \u2192 caminho com sele\xE7\xF5es de m\xE9dio porte at\xE9 semifinal", potentialOpponents: ["Cro\xE1cia", "Holanda"], difficulty: 5 },
    { scenario: "dangerous", description: "2\xBA do grupo \u2192 Fran\xE7a ou Inglaterra nas oitavas", potentialOpponents: ["Fran\xE7a", "Inglaterra"], difficulty: 9 }
  ],
  franca: [
    { scenario: "favorable", description: "1\xBA do grupo \u2192 advers\xE1rios de grupos equilibrados at\xE9 semifinal", potentialOpponents: ["Sele\xE7\xE3o do Grupo D (2\xBA)"], difficulty: 4 },
    { scenario: "likely", description: "1\xBA do grupo \u2192 caminho com poss\xEDvel encontro contra Portugal nas quartas", potentialOpponents: ["Portugal"], difficulty: 6 },
    { scenario: "dangerous", description: "2\xBA do grupo \u2192 Espanha ou Argentina nas oitavas", potentialOpponents: ["Espanha", "Argentina"], difficulty: 9 }
  ],
  argentina: [
    { scenario: "favorable", description: "1\xBA do grupo \u2192 caminho com sele\xE7\xF5es acess\xEDveis at\xE9 quartas", potentialOpponents: ["Sele\xE7\xE3o do Grupo B (2\xBA)"], difficulty: 3 },
    { scenario: "likely", description: "1\xBA do grupo \u2192 encontro poss\xEDvel com Alemanha ou Holanda", potentialOpponents: ["Alemanha", "Holanda"], difficulty: 5 },
    { scenario: "dangerous", description: "2\xBA do grupo \u2192 poss\xEDvel Fran\xE7a nas oitavas", potentialOpponents: ["Fran\xE7a"], difficulty: 8 }
  ],
  inglaterra: [
    { scenario: "favorable", description: "1\xBA do grupo \u2192 caminho com advers\xE1rios de segundo escal\xE3o", potentialOpponents: ["Sele\xE7\xE3o do Grupo F (2\xBA)"], difficulty: 3 },
    { scenario: "likely", description: "1\xBA do grupo \u2192 poss\xEDvel Alemanha nas quartas", potentialOpponents: ["Alemanha"], difficulty: 5 },
    { scenario: "dangerous", description: "2\xBA do grupo \u2192 Espanha nas oitavas", potentialOpponents: ["Espanha"], difficulty: 9 }
  ]
};
const RECENT_FORM = {
...
const INJURIES = [
  ...
  { player: "Pedri", status: "available", statusLabel: "Dispon\xEDvel", lastUpdated: "12/06/2026", teamId: "espanha" },
  // France
  { player: "Kylian Mbapp\xE9", status: "available", statusLabel: "Dispon\xEDvel", lastUpdated: "12/06/2026", teamId: "franca" },
  // England
  { player: "Bukayo Saka", status: "returning", statusLabel: "Retornando", lastUpdated: "08/06/2026", teamId: "inglaterra" },
  // Argentina
  { player: "Lionel Messi", status: "available", statusLabel: "Dispon\xEDvel", lastUpdated: "12/06/2026", teamId: "argentina" },
  { player: "Cristian Romero", status: "doubt", statusLabel: "D\xFAvida", lastUpdated: "11/06/2026", teamId: "argentina" },
  // Brazil
  { player: "Neymar", status: "doubt", statusLabel: "D\xFAvida", lastUpdated: "10/06/2026", teamId: "brasil" },
  { player: "Alisson", status: "available", statusLabel: "Dispon\xEDvel", lastUpdated: "12/06/2026", teamId: "brasil" },
  { player: "Rodrygo", status: "available", statusLabel: "Dispon\xEDvel", lastUpdated: "12/06/2026", teamId: "brasil" },
  { player: "\xC9der Milit\xE3o", status: "returning", statusLabel: "Retornando", lastUpdated: "09/06/2026", teamId: "brasil" },
  { player: "Est\xEAv\xE3o", status: "available", statusLabel: "Dispon\xEDvel", lastUpdated: "12/06/2026", teamId: "brasil" },
  // Germany
  { player: "Florian Wirtz", status: "available", statusLabel: "Dispon\xEDvel", lastUpdated: "12/06/2026", teamId: "alemanha" },
  { player: "Jamal Musiala", status: "available", statusLabel: "Dispon\xEDvel", lastUpdated: "12/06/2026", teamId: "alemanha" }
];
const UPSET_RISK = {
  favoritesAtRisk: [
    { team: "Fran\xE7a", flag: "\u{1F1EB}\u{1F1F7}", riskFactors: ["Grupo muito dif\xEDcil", "Desgaste precoce poss\xEDvel"] },
    { team: "Brasil", flag: "\u{1F1E7}\u{1F1F7}", riskFactors: ["Muitas les\xF5es", "Pouco tempo de trabalho"] },
    { team: "Holanda", flag: "\u{1F1F3}\u{1F1F1}", riskFactors: ["Chaveamento dif\xEDcil", "Inconsist\xEAncia"] },
    { team: "Uruguai", flag: "\u{1F1FA}\u{1F1FE}", riskFactors: ["Momento irregular", "Grupo com Espanha"] },
    { team: "B\xE9lgica", flag: "\u{1F1E7}\u{1F1EA}", riskFactors: ["For\xE7a real inferior \xE0 reputa\xE7\xE3o", "Transi\xE7\xE3o geracional"] }
  ],
  giantKillers: [
    { team: "Noruega", flag: "\u{1F1F3}\u{1F1F4}", strengths: ["Haaland e \xD8degaard", "Ataque explosivo"] },
    { team: "Col\xF4mbia", flag: "\u{1F1E8}\u{1F1F4}", strengths: ["Boa posi\xE7\xE3o no Elo", "Experi\xEAncia nos EUA"] },
    { team: "Marrocos", flag: "\u{1F1F2}\u{1F1E6}", strengths: ["Experi\xEAncia de 2022", "Elenco jovem"] },
    { team: "Equador", flag: "\u{1F1EA}\u{1F1E8}", strengths: ["For\xE7a defensiva", "Transi\xE7\xE3o r\xE1pida"] },
    { team: "Jap\xE3o", flag: "\u{1F1EF}\u{1F1F5}", strengths: ["Organiza\xE7\xE3o t\xE1tica", "Capacidade f\xEDsica"] },
    { team: "Senegal", flag: "\u{1F1F8}\u{1F1F3}", strengths: ["For\xE7a f\xEDsica", "Jogadores em grandes ligas"] },
    { team: "Cro\xE1cia", flag: "\u{1F1ED}\u{1F1F7}", strengths: ["Experi\xEAncia competitiva", "Genialidade de Modri\u0107"] },
    { team: "Turquia", flag: "\u{1F1F9}\u{1F1F7}", strengths: ["Talento jovem", "Jogadores decisivos"] }
  ]
};
const METHODOLOGY_WEIGHTS = [
  { key: "strengthRankings", label: "For\xE7a atual e rankings", default: 20, description: "Ranking FIFA, Elo e for\xE7a ponderada atual" },
  { key: "squadDepth", label: "Elenco e profundidade", default: 20, description: "Qualidade dos titulares, banco, versatilidade e estrelas" },
  { key: "recentForm", label: "Momento recente", default: 15, description: "Desempenho nos \xFAltimos 12-24 meses em jogos oficiais e amistosos" },
  { key: "coachModel", label: "T\xE9cnico e modelo de jogo", default: 10, description: "Qualidade do treinador e sistema t\xE1tico" },
  { key: "groupPath", label: "Grupo e chaveamento", default: 15, description: "Dificuldade do grupo e caminho projetado at\xE9 a final" },
  { key: "fitness", label: "Situa\xE7\xE3o f\xEDsica", default: 10, description: "Les\xF5es, retornos e carga de jogos recentes" },
  { key: "knockoutExp", label: "Experi\xEAncia em mata-mata", default: 10, description: "Hist\xF3rico da sele\xE7\xE3o e dos jogadores em decis\xF5es" }
];
const GEOGRAPHIC_ADVANTAGE = [
  { team: "Argentina", flag: "\u{1F1E6}\u{1F1F7}", advantage: "Familiaridade com clima latino-americano e torcida pr\xF3xima" },
  { team: "Brasil", flag: "\u{1F1E7}\u{1F1F7}", advantage: "Hist\xF3rico de competi\xE7\xF5es nas Am\xE9ricas e adapta\xE7\xE3o a fusos variados" },
  { team: "Col\xF4mbia", flag: "\u{1F1E8}\u{1F1F4}", advantage: "Experi\xEAncia recente em est\xE1dios dos EUA durante torneios continentais" },
  { team: "Uruguai", flag: "\u{1F1FA}\u{1F1FE}", advantage: "Adapta\xE7\xE3o ao clima e estilo de jogo f\xEDsico do continente" },
  { team: "M\xE9xico", flag: "\u{1F1F2}\u{1F1FD}", advantage: "Pa\xEDs-sede: conhecimento dos est\xE1dios, clima e fuso hor\xE1rio" },
  { team: "Estados Unidos", flag: "\u{1F1FA}\u{1F1F8}", advantage: "Pa\xEDs-sede: zero deslocamento entre fusos, torcida local" },
  { team: "Canad\xE1", flag: "\u{1F1E8}\u{1F1E6}", advantage: "Pa\xEDs-sede: adapta\xE7\xE3o ao clima e altitude de algumas sedes" }
];
const _sfc_main$h = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="section-inner"><p class="section-label animate-fade-in"> Vis\xE3o geral </p><h2 id="comparativo-title" class="section-headline animate-fade-in"> Resumo executivo </h2><p class="section-subhead mt-2 mb-10 animate-fade-in"> Os principais insights da an\xE1lise entre as candidatas ao t\xEDtulo da Copa do Mundo FIFA 2026. </p><blockquote class="pull-quote mb-12 animate-fade-in"> &quot;A Espanha \xE9 hoje a sele\xE7\xE3o mais completa, mas Fran\xE7a, Inglaterra e Argentina permanecem pr\xF3ximas.&quot; </blockquote><div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-8 animate-slide-up"><!--[-->`);
      ...
      _push(`<!--]--></div><div class="hr-gold mx-auto mt-12"></div><p class="mt-6 text-sm text-gray-500 leading-relaxed text-center max-w-xl mx-auto"> Os percentuais s\xE3o estimativas anal\xEDticas baseadas no modelo descrito na metodologia. N\xE3o representam certezas nem recomenda\xE7\xF5es. </p></div></section>`);
    };
  }
});
...
const _sfc_main$g = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const rankedItems = PROBABILITY_RANKING.slice(0, -1).map((item) => {
      ...
      return {
        ...item,
        justification: (_a = teamData == null ? void 0 : teamData.justification) != null ? _a : null,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="section-inner-narrow"><p class="section-label">Ranking</p><h2 id="ranking-heading" class="section-headline"> As dez sele\xE7\xF5es mais prov\xE1veis </h2><p class="section-subhead mb-14"> Probabilidade estimada de cada sele\xE7\xE3o vencer a Copa do Mundo FIFA 2026, calculada com base no modelo anal\xEDtico ponderado. </p><div class="divide-y divide-surface-800/40"><!--[-->`);
      ssrRenderList(unref(rankedItems), (item, index) => {
        _push(`<div class="${ssrRenderClass([index < 3 ? "pl-5 border-l-4 border-gold-500/70 -ml-px" : "pl-5 border-l-4 border-transparent -ml-px", "py-5 first:pt-0 last:pb-0"])}"><div class="flex items-start gap-5"><span class="${ssrRenderClass([index < 3 ? "text-3xl text-gold-500" : "text-2xl text-surface-400", "font-display font-extrabold leading-none shrink-0 mt-1"])}" aria-label="Posi\xE7\xE3o">${ssrInterpolate(index + 1)}</span><div class="flex-1 min-w-0"><div class="flex items-center gap-3 mb-2"><span class="text-2xl leading-none shrink-0" aria-hidden="true">${ssrInterpolate(item.flag)}</span><span class="${ssrRenderClass([index < 3 ? "text-2xl text-white" : "text-xl text-white", "font-display font-bold leading-tight truncate"])}">${ssrInterpolate(item.team)}</span><span class="data-percent text-2xl ml-auto shrink-0">${ssrInterpolate(item.probability.toFixed(1).replace(".", ","))}% </span></div><div class="flex items-center gap-3 mb-2"><div class="strength-bar-track flex-1 max-w-xs"><div class="${ssrRenderClass([index < 3 ? "strength-bar-fill-gold" : "strength-bar-fill-blue", "strength-bar-fill"])}" style="${ssrRenderStyle({ width: `${item.barWidth}%` })}"></div></div></div><p class="text-sm text-gray-500 leading-relaxed max-w-xl">${ssrInterpolate(item.justification)}</p></div></div></div>`);
      });
      _push(`<!--]--><div class="py-5 pl-5 border-l-4 border-transparent -ml-px opacity-70"><div class="flex items-start gap-5"><span class="font-display font-extrabold text-2xl leading-none shrink-0 mt-1 text-surface-500">\u2014</span><div class="flex-1 min-w-0"><div class="flex items-center gap-3 mb-2"><span class="text-2xl leading-none shrink-0" aria-hidden="true">${ssrInterpolate((_a = unref(othersItem)) == null ? void 0 : _a.flag)}</span><span class="font-display font-bold text-xl leading-tight truncate text-gray-400">${ssrInterpolate((_b = unref(othersItem)) == null ? void 0 : _b.team)}</span><span class="data-percent text-2xl ml-auto shrink-0">${ssrInterpolate((_c = unref(othersItem)) == null ? void 0 : _c.probability.toFixed(1).replace(".", ","))}% </span></div><div class="flex items-center gap-3 mb-1"><div class="strength-bar-track flex-1 max-w-xs"><div class="strength-bar-fill strength-bar-fill-gold" style="${ssrRenderStyle({ width: `${((_e = (_d = unref(othersItem)) == null ? void 0 : _d.probability) != null ? _e : 0) / maxProbability * 100}%` })}"></div></div></div></div></div></div></div><p class="mt-10 text-xs text-gray-600"> As probabilidades s\xE3o estimativas anal\xEDticas baseadas no modelo ponderado descrito na metodologia. N\xE3o representam certezas nem recomenda\xE7\xF5es. </p></div></section>`);
    };
  }
});
...
const _sfc_main$f = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const evidences = [
      {
        icon: "\u{1F3C6}",
        title: "Lideran\xE7a no ranking Elo",
        text: "A Espanha ocupa o primeiro lugar no ranking Elo, que mede a for\xE7a real das sele\xE7\xF5es com base em resultados hist\xF3ricos ponderados. O modelo Elo \xE9 amplamente reconhecido por sua precis\xE3o preditiva em competi\xE7\xF5es de futebol."
      },
      {
        icon: "\u{1F31F}",
        title: "T\xEDtulo da Euro 2024",
        text: "A conquista da Eurocopa de 2024 consolidou um ciclo vitorioso, derrotando advers\xE1rios como Fran\xE7a e Inglaterra. O t\xEDtulo europeu validou o projeto t\xE1tico e a capacidade da sele\xE7\xE3o em jogos de alto n\xEDvel."
      },
      {
        icon: "\u{1F504}",
        title: "Elenco jovem e profundo",
        text: "Com a segunda menor m\xE9dia de idade entre as favoritas (26,1 anos), a Espanha possui um elenco em ascend\xEAncia. Jogadores como Yamal, Pedri, Gavi e Nico Williams ainda n\xE3o atingiram seu pico de rendimento."
      },
      {
        icon: "\u2699\uFE0F",
        title: "Modelo de jogo consolidado",
        text: "Luis de la Fuente desenvolveu um sistema que combina a tradicional posse de bola espanhola com transi\xE7\xF5es r\xE1pidas e press\xE3o alta. O modelo oferece versatilidade t\xE1tica para enfrentar diferentes perfis de advers\xE1rio."
      }
    ];
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<article${ssrRenderAttrs(mergeProps({ "aria-labelledby": "spain-heading" }, _attrs))}><section class="section-light"><div class="section-inner-narrow"><div class="flex gap-1 mb-6" aria-hidden="true"><span class="w-10 h-1 bg-red-600"></span><span class="w-10 h-1 bg-gold-500"></span><span class="w-10 h-1 bg-red-600"></span></div><p class="section-label">An\xE1lise</p><h2 id="spain-heading" class="section-headline mb-6"> Por que a Espanha lidera a proje\xE7\xE3o? </h2><blockquote class="pull-quote mb-12"> &quot;A Espanha chega a 2026 com a melhor combina\xE7\xE3o de momentum competitivo, base t\xE1tica e profundidade de elenco entre todas as sele\xE7\xF5es.&quot; </blockquote><div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10 mb-14"><!--[-->`);
      ...
      _push(`<!--]--></div><div class="callout-warning"><p class="font-display font-bold text-sm uppercase tracking-wider text-amber-400 mb-1"> Principal risco </p><p class="text-gray-700"> A depend\xEAncia criativa de Lamine Yamal, a condi\xE7\xE3o f\xEDsica de Rodri e a poss\xEDvel dificuldade da Espanha em partidas f\xEDsicas e ca\xF3ticas contra sele\xE7\xF5es que explorem a transi\xE7\xE3o defensiva s\xE3o os principais fatores que podem limitar o desempenho da F\xFAria no torneio. </p></div></div></section><section class="section-dark"><div class="section-inner-narrow"><figure class="photo-placeholder rounded-sm bg-gradient-to-br from-red-600/40 via-navy-900 to-gold-500/20 aspect-[21/9]"><div class="absolute inset-0 flex items-center justify-center"><div class="text-center"><span class="text-7xl block mb-3" aria-hidden="true">\u{1F1EA}\u{1F1F8}</span><p class="font-display text-sm uppercase tracking-[0.3em] text-white/40"> La Roja \xB7 Copa do Mundo 2026 </p></div></div><figcaption class="absolute bottom-3 right-4 text-xs text-white/30"> Ilustra\xE7\xE3o editorial </figcaption></figure></div></section><section class="section-light"><div class="section-inner-narrow"><p class="text-lg text-gray-700 leading-relaxed mb-6"> Com uma m\xE9dia de idade de apenas 26,1 anos, a Espanha combina a experi\xEAncia de jogadores como Rodri e Carvajal com a explos\xE3o de talentos como Lamine Yamal, Nico Williams e Pedri. O modelo de jogo consolidado por Luis de la Fuente, baseado em press\xE3o alta e controle de posse, oferece solidez t\xE1tica contra diferentes estilos de advers\xE1rio. </p><div class="flex items-center gap-3 pt-4 border-t border-gray-200"><span class="text-sm text-gray-500">Proje\xE7\xE3o atual</span><span class="stat-badge-gold">16,5% de probabilidade</span></div></div></section></article>`);
    };
  }
});
  ...
  setup(__props) {
    const profiles = computed(() => {
      ...
      return [
        {
          team: franca,
          positionLabel: "1\xAA concorrente",
          gradientClass: "from-blue-600 via-navy-800 to-red-600",
          analysis: "A Fran\xE7a chega como a principal amea\xE7a ao dom\xEDnio espanhol. O elenco mais profundo da competi\xE7\xE3o soma experi\xEAncia acumulada em duas finais de Copa consecutivas, com Kylian Mbapp\xE9 como refer\xEAncia ofensiva e um sistema defensivo consolidado por Didier Deschamps. O grupo dif\xEDcil \xE9 o contraponto que pode desgastar a equipe precocemente.",
          mainStrength: "Elenco mais profundo e experi\xEAncia de mata-mata",
          mainRisk: "Grupo muito dif\xEDcil e desgaste precoce",
          decisivePlayer: "Kylian Mbapp\xE9"
        },
        {
          team: inglaterra,
          positionLabel: "2\xAA concorrente",
          gradientClass: "from-blue-900 via-navy-800 to-red-900",
          analysis: "A Inglaterra re\xFAne um conjunto ofensivo de alto n\xEDvel com Kane, Bellingham e Saka, sustentado por um meio-campo s\xF3lido comandado por Declan Rice. Thomas Tuchel assume o comando com a miss\xE3o de traduzir talento individual em resultado coletivo. O hist\xF3rico de trope\xE7os em momentos decisivos, por\xE9m, segue como sombra sobre as expectativas.",
          mainStrength: "Talento ofensivo e elenco profundo",
          mainRisk: "Hist\xF3rico de derrotas em decis\xF5es",
          decisivePlayer: "Jude Bellingham"
        },
        {
          team: argentina,
          positionLabel: "3\xAA concorrente",
          gradientClass: "from-sky-500 via-white/10 to-sky-500",
          analysis: "Atual campe\xE3 mundial e bicampe\xE3 da Copa Am\xE9rica, a Argentina de Lionel Scaloni \xE9 o retrato da estabilidade competitiva. O time sabe exatamente como jogar e como sofrer, apoiado em uma estrutura defensiva s\xF3lida e na capacidade de controle emocional que poucas sele\xE7\xF5es t\xEAm. Messi segue como maestro, mas a idade dos l\xEDderes e a condi\xE7\xE3o f\xEDsica do camisa 10 acendem alertas.",
          mainStrength: "Estabilidade competitiva e experi\xEAncia em decis\xF5es",
          mainRisk: "Idade dos l\xEDderes e condi\xE7\xE3o f\xEDsica de Messi",
...
const _sfc_main$d = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const comparisonCriteria = [
      { key: "strengthScore", label: "For\xE7a atual" },
      { key: "squadScore", label: "Elenco" },
      { key: "formScore", label: "Momento" },
      { key: "coachScore", label: "T\xE9cnico" },
      { key: "pathScore", label: "Caminho" },
      { key: "fitnessScore", label: "Sa\xFAde f\xEDsica" },
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="section-inner"><h2 id="comparison-heading" class="section-headline mb-4"> Compara\xE7\xE3o entre favoritas </h2><p class="section-subhead mb-10"> As notas de Espanha, Fran\xE7a e Inglaterra em cada dimens\xE3o analisada pelo modelo. </p><div class="overflow-x-auto rounded-sm border border-gray-200 mb-8"><table class="table-editorial"><thead><tr><th class="w-44">Crit\xE9rio</th><!--[-->`);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({
        class: "section-dark",
        "aria-labelledby": "ranking-heading"
      }, _attrs))}><div class="section-inner"><p class="section-label">Rankings</p><h2 id="ranking-heading" class="section-headline mb-4"> FIFA versus Elo: dois rankings, duas leituras </h2><p class="section-subhead mb-12"> Dois sistemas de classifica\xE7\xE3o com metodologias distintas. Entender as diferen\xE7as ajuda a interpretar por que algumas sele\xE7\xF5es aparecem melhor posicionadas em um ranking do que em outro. </p><div class="grid md:grid-cols-2 gap-8 mb-14"><article class="editorial-card-border p-6 lg:p-8"><div class="flex items-center gap-3 mb-5"><span class="w-9 h-9 rounded-sm bg-blue-500/15 flex items-center justify-center text-blue-400 font-display font-bold text-sm border border-blue-500/20">FIFA</span><h3 class="font-display text-xl font-bold text-white">Ranking FIFA</h3></div><p class="text-sm text-gray-400 leading-relaxed mb-5 font-sans"> Sistema oficial da Federa\xE7\xE3o Internacional de Futebol, criado em 1993. Utilizado institucionalmente para definir cabe\xE7as de chave, distribui\xE7\xE3o de potes e sorteios de competi\xE7\xF5es oficiais. </p><ul class="space-y-3 text-sm text-gray-400"><li class="flex items-start gap-3"><span class="w-1.5 h-1.5 rounded-full bg-blue-400 mt-1.5 shrink-0" aria-hidden="true"></span><span class="font-sans">Considera o peso da partida \u2014 amistosos valem menos que jogos de Copa.</span></li><li class="flex items-start gap-3"><span class="w-1.5 h-1.5 rounded-full bg-blue-400 mt-1.5 shrink-0" aria-hidden="true"></span><span class="font-sans">Atualizado mensalmente; tende a reagir com atraso a mudan\xE7as de desempenho.</span></li><li class="flex items-start gap-3"><span class="w-1.5 h-1.5 rounded-full bg-blue-400 mt-1.5 shrink-0" aria-hidden="true"></span><span class="font-sans">Criticado por analistas por penalizar sele\xE7\xF5es que enfrentam advers\xE1rios fortes.</span></li></ul><div class="mt-6 pt-5 border-t border-surface-800/40"><span class="stat-badge-neutral text-xs">Oficial \xB7 Usado em sorteios</span></div></article><article class="editorial-card-border p-6 lg:p-8"><div class="flex items-center gap-3 mb-5"><span class="w-9 h-9 rounded-sm bg-gold-500/15 flex items-center justify-center text-gold-400 font-display font-bold text-sm border border-gold-500/20">ELO</span><h3 class="font-display text-xl font-bold text-white">Ranking Elo</h3></div><p class="text-sm text-gray-400 leading-relaxed mb-5 font-sans"> Sistema independente e n\xE3o oficial, adaptado do m\xE9todo criado por Arpad Elo para o xadrez. Amplamente usado por analistas esportivos por sua sensibilidade \xE0 forma real das sele\xE7\xF5es. </p><ul class="space-y-3 text-sm text-gray-400"><li class="flex items-start gap-3"><span class="w-1.5 h-1.5 rounded-full bg-gold-400 mt-1.5 shrink-0" aria-hidden="true"></span><span class="font-sans">Considera for\xE7a do advers\xE1rio, diferen\xE7a de gols e mando de campo.</span></li><li class="flex items-start gap-3"><span class="w-1.5 h-1.5 rounded-full bg-gold-400 mt-1.5 shrink-0" aria-hidden="true"></span><span class="font-sans">Atualiza ap\xF3s cada partida \u2014 captura mudan\xE7as de forma em tempo real.</span></li><li class="flex items-start gap-3"><span class="w-1.5 h-1.5 rounded-full bg-gold-400 mt-1.5 shrink-0" aria-hidden="true"></span><span class="font-sans">Considerado mais preciso por refletir a qualidade real e n\xE3o o peso da competi\xE7\xE3o.</span></li></ul><div class="mt-6 pt-5 border-t border-surface-800/40"><span class="stat-badge-gold text-xs">Independente \xB7 Atualiza\xE7\xE3o cont\xEDnua</span></div></article></div><div class="editorial-card-border p-6 lg:p-8 mb-8"><h3 class="font-display text-lg font-bold text-white mb-6"> Compara\xE7\xE3o direta: as seis favoritas </h3><div class="overflow-x-auto"><table class="table-editorial"><thead><tr><th>Sele\xE7\xE3o</th><th class="text-center">FIFA</th><th class="text-center">Elo</th><th class="text-center">Diferen\xE7a</th></tr></thead><tbody><!--[-->`);
      ssrRenderList(tableData.value, (entry) => {
        _push(`<tr><td class="flex items-center gap-2.5"><span class="text-lg leading-none" aria-hidden="true">${ssrInterpolate(entry.flag)}</span><span class="font-medium text-white font-sans">${ssrInterpolate(entry.name)}</span></td><td class="text-center"><span class="font-mono tabular-nums text-gray-300">${ssrInterpolate(entry.fifaRank)}\xBA</span></td><td class="text-center"><span class="font-mono tabular-nums text-gray-300">${ssrInterpolate(entry.eloRank)}\xBA</span></td><td class="text-center"><span class="${ssrRenderClass([entry.diffClass, "font-mono font-semibold tabular-nums"])}">${ssrInterpolate(entry.diff > 0 ? "+" : "")}${ssrInterpolate(entry.diff)}</span></td></tr>`);
      });
      _push(`<!--]--></tbody></table></div><div class="mt-4 flex items-center gap-4 text-xs text-gray-500"><span class="flex items-center gap-1.5"><span class="w-2 h-2 rounded-full bg-green-400/60" aria-hidden="true"></span> Positivo = melhor no Elo </span><span class="flex items-center gap-1.5"><span class="w-2 h-2 rounded-full bg-red-400/60" aria-hidden="true"></span> Negativo = melhor na FIFA </span></div></div><div class="callout-info"><p class="text-sm leading-relaxed font-sans"> A diferen\xE7a entre os dois rankings exp\xF5e sele\xE7\xF5es que podem estar sub ou supervalorizadas pelo sistema oficial. Quanto maior a diferen\xE7a positiva, mais o ranking Elo enxerga a sele\xE7\xE3o acima da posi\xE7\xE3o FIFA \u2014 um sinal de que o desempenho recente pode estar sendo subestimado pelo sistema oficial. </p></div></div></section>`);
    };
  }
});
...
const _sfc_main$b = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div></div><div class="callout-warning"><p class="text-sm leading-relaxed font-sans"> O chaveamento definitivo depende tamb\xE9m da combina\xE7\xE3o dos oito melhores terceiros colocados. Os cen\xE1rios acima consideram a classifica\xE7\xE3o em primeiro lugar como cen\xE1rio base. </p></div></div></section>`);
    };
  }
});
...
const _sfc_main$a = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const knockoutPaths = computed(
      () => {
        var _a;
        return (_a = KNOCKOUT_PATHS[selectedTeamId.value]) != null ? _a : [];
      }
    );
    ...
    function scenarioLabel(scenario) {
      switch (scenario) {
        case "favorable":
          return "Cen\xE1rio favor\xE1vel";
        case "likely":
          return "Cen\xE1rio prov\xE1vel";
        case "dangerous":
          return "Cen\xE1rio perigoso";
        default:
          return "Cen\xE1rio";
      }
    }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (knockoutPaths.value.length > 0) {
        ...
        _push(`<p class="text-sm text-gray-500 italic font-sans"> Nenhum cen\xE1rio de chaveamento dispon\xEDvel para esta sele\xE7\xE3o. </p>`);
      }
      if (groupInfo.value) {
      ...
      _push(`<div class="mt-6 callout-warning"><p class="text-sm leading-relaxed font-sans"> Confrontos condicionais \u2014 dependem da classifica\xE7\xE3o de terceiros colocados e da combina\xE7\xE3o de resultados entre grupos. Os cen\xE1rios s\xE3o baseados no chaveamento esperado e podem mudar conforme os resultados da fase de grupos. </p></div></div></section>`);
    };
  }
});
...
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function timelineMatches(summary) {
      ...
      const matches = [];
      const opponents = ["Uruguai", "Camar\xF5es", "Ar\xE1bia Saudita", "Alemanha", "Jap\xE3o", "M\xE9xico", "Col\xF4mbia", "Gana", "Cro\xE1cia", "Su\xED\xE7a"];
      const comps = ["Amistoso", "Liga das Na\xE7\xF5es", "Eliminat\xF3rias", "Copa Am\xE9rica", "Eurocopa", "Amistoso", "Liga das Na\xE7\xF5es", "Eliminat\xF3rias", "Amistoso", "Amistoso"];
      const results = [];
      ...
      for (let i = 0; i < count; i++) {
        ...
        matches.push({
          result: r,
          resultLabel: isWin ? "Vit\xF3ria" : isDraw ? "Empate" : "Derrota",
    ...
    function narrativeSummary(summary) {
      ...
      return `teve um aproveitamento de ${winRate}% no per\xEDodo, com m\xE9dia de ${avgGF} gols marcados e ${avgGA} gols sofridos por partida. O saldo de gols (${f.goalsFor - f.goalsAgainst > 0 ? "+" : ""}${f.goalsFor - f.goalsAgainst}) reflete ${f.goalsFor - f.goalsAgainst > 15 ? "dom\xEDnio absoluto" : f.goalsFor - f.goalsAgainst > 5 ? "superioridade consistente" : "equil\xEDbrio competitivo"} em jogos oficiais e amistosos.`;
    }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="section-inner"><p class="section-label">An\xE1lise de desempenho</p><h2 id="form-heading" class="section-headline"> Forma recente (\xFAltimos 24 meses) </h2><p class="section-subhead mb-12"> Desempenho das principais favoritas em partidas oficiais e amistosas entre junho de 2024 e junho de 2026. Inclui Eliminat\xF3rias, Liga das Na\xE7\xF5es, Copa Am\xE9rica, Eurocopa e amistosos de prepara\xE7\xE3o. </p><div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 mb-10"><!--[-->`);
      ...
      _push(`<!--]--></div><div role="tablist" aria-label="Selecionar sele\xE7\xE3o" class="flex overflow-x-auto gap-1 pb-3 mb-8 border-b border-surface-800/60"><!--[-->`);
      ssrRenderList(matchSummaries.value, (team) => {
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const activeTeamData = computed(() => {
      ...
      if (!team) return null;
      const players = (_a = team.keyPlayers) != null ? _a : [];
      const strengths = (_b = team.strengths) != null ? _b : [];
      const risks = (_c = team.risks) != null ? _c : [];
      const captain = (_e = (_d = players[0]) != null ? _d : team.coach) != null ? _e : "\u2014";
      const decisive = (_g = (_f = players[1]) != null ? _f : players[0]) != null ? _g : "\u2014";
      const risingStar = (_h = players[players.length - 1]) != null ? _h : "\u2014";
      ...
      const strongest = (_i = positionMap[team.id]) != null ? _i : "Meio-campo";
      const weakest = (_j = weakestMap[team.id]) != null ? _j : "Defesa";
      const strengthNote = strengths.length > 0 ? strengths.slice(0, 2).join(" e ") : "Elenco equilibrado";
      const riskNote = risks.length > 0 ? risks[0] : "Requer aten\xE7\xE3o";
      return {
        captain,
        decisive,
        risingStar,
    ...
    function positionIcon(position) {
      ...
      if (position.includes("Meio")) return "\u{1F3AF}";
      if (position.includes("Def") || position.includes("Zag") || position.includes("Late")) return "\u{1F6E1}\uFE0F";
      if (position.includes("Goleiro")) return "\u{1F9E4}";
      return "\u{1F3C3}";
    }
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({
      ...
      }, _attrs))}><div class="section-inner"><p class="section-label">Elenco</p><h2 id="keyplayers-heading" class="section-headline"> Elencos e jogadores decisivos </h2><p class="section-subhead mb-12"> An\xE1lise dos plant\xE9is das principais candidatas ao t\xEDtulo, com destaques individuais por posi\xE7\xE3o e fun\xE7\xE3o t\xE1tica. </p><div role="tablist" aria-label="Sele\xE7\xF5es" class="flex overflow-x-auto gap-1 pb-3 mb-10 border-b border-gray-200"><!--[-->`);
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const filters = [
      ...
      { value: "available", label: "Dispon\xEDveis" },
      { value: "returning", label: "Retornando" },
      { value: "doubt", label: "D\xFAvidas" },
    ...
    function statusClass(status) {
      var _a, _b;
      return (_b = (_a = statusStyles[status]) == null ? void 0 : _a.container) != null ? _b : "bg-gray-500/10 text-gray-400 border border-gray-500/20";
    }
    function statusDotClass(status) {
      var _a, _b;
      return (_b = (_a = statusStyles[status]) == null ? void 0 : _a.dot) != null ? _b : "bg-gray-400";
    }
    ...
    function getTeamFlag(teamId) {
      var _a, _b;
      return (_b = (_a = TEAMS.find((t) => t.id === teamId)) == null ? void 0 : _a.flag) != null ? _b : "";
    }
    function getPosition(injury) {
      ...
      const positionMap = {
        ...
        "Alisson": "Goleiro",
        "Rodrygo": "Atacante",
        "\xC9der Milit\xE3o": "Zagueiro",
        "Est\xEAv\xE3o": "Ponta",
        "Florian Wirtz": "Meia",
        "Jamal Musiala": "Meia"
      };
      return (_a = positionMap[injury.player]) != null ? _a : "Jogador";
    }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="section-inner"><p class="section-label">Boletim m\xE9dico</p><h2 id="injury-heading" class="section-headline"> Les\xF5es e riscos f\xEDsicos </h2><p class="section-subhead mb-10"> Situa\xE7\xE3o f\xEDsica dos principais jogadores das sele\xE7\xF5es favoritas, atualizada conforme dados p\xFAblicos dispon\xEDveis em junho de 2026. </p><div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8"><!--[-->`);
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="section-inner"><p class="section-label">Surpresas</p><h2 id="hidden-heading" class="section-headline"> Tr\xEAs sele\xE7\xF5es que podem quebrar as previs\xF5es </h2><div class="mt-12 space-y-16 md:space-y-24"><!--[-->`);
      ssrRenderList(hiddenCards.value, (item, idx) => {
        var _a, _b;
        _push(`<article class="grid md:grid-cols-5 gap-6 md:gap-10 items-center"><div class="${ssrRenderClass([idx % 2 === 1 ? "md:order-2" : "", "md:col-span-2 photo-placeholder aspect-[4/3] rounded-sm"])}" style="${ssrRenderStyle({ backgroundImage: flagGradient(item.team.id) })}"><div class="absolute bottom-4 left-5 z-10"><span class="text-5xl block drop-shadow-lg" aria-hidden="true">${ssrInterpolate(item.team.flag)}</span></div></div><div class="${ssrRenderClass(idx % 2 === 1 ? "md:col-span-3 md:order-1" : "md:col-span-3")}"><h3 class="text-2xl lg:text-3xl font-display font-extrabold text-gray-900 leading-tight">${ssrInterpolate(item.team.name)}</h3><div class="mt-4 flex items-center gap-2"><span class="text-xs font-semibold uppercase tracking-wider text-gold-600">Jogador-chave</span><span class="tag-gold text-sm">${ssrInterpolate((_a = item.team.keyPlayers) == null ? void 0 : _a[0])}</span></div><div class="mt-4"><p class="text-xs font-semibold uppercase tracking-wider text-gray-500">Principal for\xE7a</p><p class="font-sans text-base text-gray-700 mt-1 leading-relaxed font-medium">${ssrInterpolate((_b = item.team.strengths) == null ? void 0 : _b[0])}</p></div><div class="mt-6 pt-6 border-t border-gray-200"><p class="font-serif text-base italic text-gray-600 leading-relaxed">${ssrInterpolate(item.team.justification)}</p></div></div></article>`);
      });
      _push(`<!--]--></div><div class="callout-info mt-16 max-w-2xl mx-auto"><span aria-hidden="true">\u24D8</span> A express\xE3o &quot;quebrar as previs\xF5es&quot; indica que a for\xE7a competitiva destas sele\xE7\xF5es pode ser maior do que a percep\xE7\xE3o p\xFAblica atual. N\xE3o representa recomenda\xE7\xE3o de aposta. </div></div></section>`);
    };
  }
});
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="section-inner"><p class="section-label">Cen\xE1rios</p><h2 id="upset-heading" class="section-headline"> Risco de zebra </h2><p class="section-subhead mt-2 mb-10"> Favoritas expostas a elimina\xE7\xF5es precoces e as sele\xE7\xF5es com maior potencial para surpreender. </p><div class="grid md:grid-cols-2 gap-10 md:gap-12"><div><h3 class="flex items-center gap-2 text-lg font-display font-bold text-red-400 mb-5"><span aria-hidden="true" class="text-xl">\u26A0</span> Favoritas sob risco </h3><ul class="space-y-4"><!--[-->`);
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="section-inner"><p class="section-label">Contexto</p><h2 id="geographic-heading" class="section-headline"> Fator geogr\xE1fico </h2><p class="section-subhead mt-2 mb-10"> A Copa de 2026 ser\xE1 disputada em tr\xEAs pa\xEDses da Am\xE9rica do Norte, com desafios de dist\xE2ncia, clima e adapta\xE7\xE3o. </p><figure class="mb-12" aria-label="Mapa estilizado da Am\xE9rica do Norte com poss\xEDveis sedes da Copa 2026"><div class="relative w-full max-w-4xl mx-auto aspect-[4/3] bg-gray-200 border border-gray-300 rounded-sm overflow-hidden"><svg class="absolute inset-0 w-full h-full opacity-[0.08]" aria-hidden="true"><defs><pattern id="grid-pattern-light" width="40" height="40" patternUnits="userSpaceOnUse"><path d="M 40 0 L 0 0 0 40" fill="none" stroke="currentColor" class="text-gray-500" stroke-width="0.5"></path></pattern></defs><rect width="100%" height="100%" fill="url(#grid-pattern-light)"></rect></svg><div class="absolute top-[5%] left-[8%] w-[84%] h-[28%] bg-gray-300/80 rounded-tr-3xl rounded-tl-3xl border border-gray-400/40" aria-hidden="true"></div><div class="absolute top-[28%] left-[8%] w-[75%] h-[42%] bg-gray-300/60 border border-gray-400/30" aria-hidden="true"></div><div class="absolute top-[58%] left-[12%] w-[45%] h-[30%] bg-gray-300/70 border border-gray-400/30" aria-hidden="true"></div><div class="absolute top-[22%] left-[45%] w-3 h-3 bg-gold-600/80 rounded-full shadow-lg shadow-gold-600/30" aria-hidden="true" title="Toronto"></div><div class="absolute top-[35%] left-[28%] w-3 h-3 bg-gold-600/80 rounded-full shadow-lg shadow-gold-600/30" aria-hidden="true" title="Los Angeles"></div><div class="absolute top-[40%] left-[55%] w-3 h-3 bg-gold-600/80 rounded-full shadow-lg shadow-gold-600/30" aria-hidden="true" title="Kansas City"></div><div class="absolute top-[48%] left-[42%] w-3 h-3 bg-gold-600/80 rounded-full shadow-lg shadow-gold-600/30" aria-hidden="true" title="Dallas"></div><div class="absolute top-[52%] left-[62%] w-3 h-3 bg-gold-600/80 rounded-full shadow-lg shadow-gold-600/30" aria-hidden="true" title="Atlanta"></div><div class="absolute top-[33%] left-[70%] w-3 h-3 bg-gold-600/80 rounded-full shadow-lg shadow-gold-600/30" aria-hidden="true" title="New York"></div><div class="absolute top-[46%] left-[72%] w-3 h-3 bg-gold-600/80 rounded-full shadow-lg shadow-gold-600/30" aria-hidden="true" title="Miami"></div><div class="absolute top-[70%] left-[35%] w-4 h-4 bg-gold-600 rounded-full shadow-lg shadow-gold-600/40 ring-2 ring-gold-500/40" aria-hidden="true" title="Cidade do M\xE9xico"></div><div class="absolute top-[82%] left-[55%] w-3 h-3 bg-gold-600/80 rounded-full shadow-lg shadow-gold-600/30" aria-hidden="true" title="Monterrey"></div><figcaption class="absolute bottom-3 left-4 text-xs text-gray-500 font-mono"> Representa\xE7\xE3o estilizada \u2014 Am\xE9rica do Norte </figcaption></div></figure><div class="max-w-3xl mx-auto mb-12"><h3 class="text-lg font-display font-bold text-gray-900 mb-5">Fatores geogr\xE1ficos que influenciam o torneio</h3><ul class="space-y-3 text-sm text-gray-700"><li class="flex items-start gap-3"><span aria-hidden="true" class="text-gold-600 mt-0.5 shrink-0 font-bold text-lg leading-none">\u2022</span><div><strong class="text-gray-900">Longas viagens:</strong><span> dist\xE2ncias superiores a 4.000 km entre algumas sedes exigem planejamento de recupera\xE7\xE3o.</span></div></li><li class="flex items-start gap-3"><span aria-hidden="true" class="text-gold-600 mt-0.5 shrink-0 font-bold text-lg leading-none">\u2022</span><div><strong class="text-gray-900">Diferentes fusos hor\xE1rios:</strong><span> at\xE9 3 fusos entre sedes impactam o ritmo circadiano dos atletas.</span></div></li><li class="flex items-start gap-3"><span aria-hidden="true" class="text-gold-600 mt-0.5 shrink-0 font-bold text-lg leading-none">\u2022</span><div><strong class="text-gray-900">Altitude:</strong><span> est\xE1dios na Cidade do M\xE9xico (2.250m) influenciam a din\xE2mica das partidas.</span></div></li><li class="flex items-start gap-3"><span aria-hidden="true" class="text-gold-600 mt-0.5 shrink-0 font-bold text-lg leading-none">\u2022</span><div><strong class="text-gray-900">Calor e umidade:</strong><span> sedes como Miami e Houston apresentam condi\xE7\xF5es desgastantes.</span></div></li><li class="flex items-start gap-3"><span aria-hidden="true" class="text-gold-600 mt-0.5 shrink-0 font-bold text-lg leading-none">\u2022</span><div><strong class="text-gray-900">Est\xE1dios cobertos:</strong><span> parte das sedes oferece controle clim\xE1tico, reduzindo o impacto de fatores externos.</span></div></li><li class="flex items-start gap-3"><span aria-hidden="true" class="text-gold-600 mt-0.5 shrink-0 font-bold text-lg leading-none">\u2022</span><div><strong class="text-gray-900">Necessidade de recupera\xE7\xE3o:</strong><span> calend\xE1rio mais compacto com o formato de 48 sele\xE7\xF5es exige elenco profundo.</span></div></li><li class="flex items-start gap-3"><span aria-hidden="true" class="text-gold-600 mt-0.5 shrink-0 font-bold text-lg leading-none">\u2022</span><div><strong class="text-gray-900">Impacto do oitavo jogo:</strong><span> o novo formato exige um jogo adicional para chegar ao t\xEDtulo, aumentando o desgaste acumulado.</span></div></li></ul></div><h3 class="text-lg font-display font-bold text-gray-900 mb-5">Sele\xE7\xF5es com vantagem geogr\xE1fica</h3><div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6"><!--[-->`);
      ...
      _push(`<!--]--></div><div class="callout-info max-w-xl mx-auto"><span aria-hidden="true">\u24D8</span> Vantagem geogr\xE1fica n\xE3o substitui for\xE7a t\xE9cnica. </div></div></section>`);
    };
  }
});
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="section-inner-narrow"><p class="section-label">Transpar\xEAncia</p><h2 id="methodology-heading" class="section-headline"> Metodologia </h2><p class="section-subhead mt-2 mb-8"> A proje\xE7\xE3o combina <strong class="text-white">sete fatores ponderados</strong>: rankings FIFA e Elo, forma recente, qualidade e profundidade do elenco, situa\xE7\xE3o de les\xF5es, t\xE9cnico e modelo de jogo, dificuldade do grupo e caminho no chaveamento, experi\xEAncia em mata-mata, adapta\xE7\xE3o geogr\xE1fica e proje\xE7\xF5es de modelos estat\xEDsticos externos. </p><div class="callout-info mb-10"><span aria-hidden="true">\u24D8</span> As probabilidades s\xE3o estimativas anal\xEDticas e n\xE3o representam certeza, recomenda\xE7\xE3o financeira ou orienta\xE7\xE3o de aposta. O ranking editorial utiliza os pesos padr\xE3o abaixo. </div><div class="editorial-card-accent p-6 mb-10"><h3 class="text-base font-display font-bold text-white mb-5">Pesos do modelo editorial</h3><div class="space-y-3"><!--[-->`);
      ...
      _push(`<!--]--></div></div><div class="border-t border-surface-800/40 pt-6"><button type="button" class="accordion-trigger w-full"${ssrRenderAttr("aria-expanded", showSimulator.value)} aria-controls="simulator-panel"><span>Crie sua pr\xF3pria simula\xE7\xE3o</span><span class="${ssrRenderClass([{ "rotate-180": showSimulator.value }, "text-lg transition-transform duration-300"])}" aria-hidden="true">\u25BE</span></button><div id="simulator-panel" class="accordion-content" style="${ssrRenderStyle({ maxHeight: showSimulator.value ? "2600px" : "0", opacity: showSimulator.value ? 1 : 0 })}" role="region"${ssrRenderAttr("aria-hidden", !showSimulator.value)}><div class="accordion-content-inner space-y-5 pt-2"><p class="text-sm"> Modifique os pesos de cada fator e recalcule para ver uma simula\xE7\xE3o personalizada. Os valores devem somar 100. O ranking editorial oficial usa os pesos padr\xE3o. </p><div class="space-y-5"><!--[-->`);
      ...
      _push(`</div><div class="flex gap-3"><button type="button" class="btn-primary text-sm disabled:opacity-40 disabled:cursor-not-allowed"${ssrIncludeBooleanAttr(totalWeight.value !== 100) ? " disabled" : ""}> Recalcular </button><button type="button" class="btn-outline text-sm"> Restaurar pesos padr\xE3o </button></div>`);
      if (recalculatedRanking.value.length > 0) {
        _push(`<div class="editorial-card-border p-5 mt-4"><h4 class="text-base font-display font-bold text-white mb-3">Simula\xE7\xE3o personalizada</h4><ol class="space-y-2"><!--[-->`);
        ...
        _push(`<!--]--></ol><p class="mt-4 text-xs text-gray-500"> Este ranking \xE9 uma simula\xE7\xE3o personalizada baseada nos pesos definidos acima. N\xE3o substitui a estimativa editorial principal. </p></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div></div></div></section>`);
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const reasons = [
      "Lideran\xE7a no ranking Elo",
      "Segundo lugar no ranking FIFA",
      "Campe\xE3 da Euro 2024",
      "Elenco jovem e profundo",
      "Modelo de jogo consolidado",
      "Boa combina\xE7\xE3o entre controle e desequil\xEDbrio",
      "Grupo administr\xE1vel",
      "Menor n\xFAmero de fragilidades estruturais"
    ];
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({
        class: "section-dark",
        "aria-labelledby": "conclusion-heading"
      }, _attrs))}><div class="section-inner-narrow"><p class="section-label">Conclus\xE3o</p><h2 id="conclusion-heading" class="section-headline mt-2 mb-8"> A sele\xE7\xE3o mais prov\xE1vel hoje \xE9 a Espanha </h2><blockquote class="pull-quote mb-10"> &quot;Se fosse necess\xE1rio escolher uma sele\xE7\xE3o apenas com base nos dados dispon\xEDveis hoje, a escolha seria a Espanha.&quot; </blockquote><div class="grid md:grid-cols-2 gap-8 mb-10"><div><h3 class="text-base font-display font-bold text-white mb-4 flex items-center gap-2"><span class="w-2 h-2 rounded-full bg-green-400" aria-hidden="true"></span> Por que a Espanha lidera </h3><ul class="space-y-2.5" role="list"><!--[-->`);
      ...
      _push(`<!--]--></ul></div><div class="callout-warning" role="alert"><div class="flex items-start gap-3"><span class="text-amber-400 text-lg mt-0.5 shrink-0" aria-hidden="true">\u26A0</span><div><h3 class="text-amber-400 font-display font-bold mb-2 text-sm"> Principal risco de esta conclus\xE3o estar errada </h3><p class="text-sm text-gray-400 leading-relaxed"> A condi\xE7\xE3o f\xEDsica de Lamine Yamal (sobrecarregado), Rodri (retornando) e Pedri (hist\xF3rico de les\xF5es) introduz vulnerabilidade. Fran\xE7a e Argentina possuem experi\xEAncia superior em jogos eliminat\xF3rios, o que pode ser determinante em partidas \xFAnicas. O modelo de jogo espanhol, baseado em controle de posse, pode ser desafiado por sele\xE7\xF5es fisicamente intensas em condi\xE7\xF5es adversas. </p></div></div></div></div><div class="hr-gold mx-auto"></div><p class="mt-6 text-sm text-gray-500 text-center max-w-lg mx-auto leading-relaxed"> A Copa do Mundo permanece um torneio de alta imprevisibilidade. Nenhuma candidata possui probabilidade dominante, e fatores como les\xF5es, chaveamento e desempenho em jogos \xFAnicos podem alterar radicalmente o cen\xE1rio. </p></div></section>`);
    };
  }
});
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const keySources = [
      ...
      { name: "Opta Analyst", url: "https://theanalyst.com/", categoryTag: "Estat\xEDstica", collectionDate: "10/06/2026" },
    ...
    const sourceCategories = [
      ...
      },
      {
        name: "Desempenho",
        sources: [
          { name: "Opta Analyst", url: "https://theanalyst.com/", categoryTag: "Proje\xE7\xE3o", collectionDate: "10/06/2026" },
          { name: "The Analyst \u2014 World Cup Predictor", url: "https://theanalyst.com/eu/", categoryTag: "Estat\xEDstica", collectionDate: "10/06/2026" }
        ]
      },
      {
        name: "Elencos e les\xF5es",
        sources: [
          { name: "Transfermarkt", url: "https://www.transfermarkt.com/", categoryTag: "Elenco", collectionDate: "12/06/2026" },
          { name: "Premier Injuries", url: "https://www.premierinjuries.com/", categoryTag: "Les\xF5es", collectionDate: "12/06/2026" }
        ]
      },
      {
        name: "Proje\xE7\xF5es estat\xEDsticas",
        sources: [
          { name: "CIES Football Observatory", url: "https://football-observatory.com/", categoryTag: "Pesquisa", collectionDate: "05/06/2026" }
        ]
      },
      {
        name: "Not\xEDcias esportivas",
        sources: [
          { name: "ESPN", url: "https://www.espn.com/", categoryTag: "Not\xEDcia", collectionDate: "12/06/2026" },
          { name: "The Athletic", url: "https://www.nytimes.com/athletic/", categoryTag: "Not\xEDcia", collectionDate: "12/06/2026" },
          { name: "BBC Sport", url: "https://www.bbc.com/sport", categoryTag: "Not\xEDcia", collectionDate: "12/06/2026" },
          { name: "Globo Esporte", url: "https://ge.globo.com/", categoryTag: "Not\xEDcia", collectionDate: "12/06/2026" }
        ]
      }
    ];
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="section-inner-narrow"><p class="section-label">Transpar\xEAncia</p><h2 id="sources-heading" class="section-headline"> Fontes </h2><p class="section-subhead mt-2 mb-8"> Transpar\xEAncia sobre a origem de cada dado utilizado na an\xE1lise. </p><div class="flex flex-wrap gap-3 mb-8"><!--[-->`);
      ...
      _push(`<!--]--></div></div></div></div><p class="mt-8 text-xs text-gray-500 text-center"> Dados atualizados em 12 de junho de 2026. Cada dado sens\xEDvel ao tempo inclui fonte e data da coleta. </p></div></section>`);
    };
  }
});
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useSeoMeta({
      ...
      description: "Uma an\xE1lise editorial sobre as sele\xE7\xF5es com maior probabilidade de vencer a Copa do Mundo FIFA 2026. Rankings, elenco, forma recente, les\xF5es, grupos e caminhos at\xE9 a final.",
      ogTitle: "Copa do Mundo 2026 \u2014 Quem tem a maior probabilidade de vencer?",
      ogDescription: "An\xE1lise editorial baseada em dados: rankings FIFA e Elo, desempenho recente, qualidade do elenco, les\xF5es e cen\xE1rios at\xE9 a final.",
      ogType: "website",
      ogLocale: "pt_BR"
    });
    return (_ctx, _push, _parent, _attrs) => {
...
//# sourceMappingURL=index-VDJvWJqH.mjs.map
