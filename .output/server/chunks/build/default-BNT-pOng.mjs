...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><span aria-hidden="true" class="transition-transform duration-300 group-hover:scale-110">${ssrInterpolate(unref(isDark2) ? "\u2600\uFE0F" : "\u{1F319}")}</span></button>`);
    };
  }
});
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const navItems = [
      ...
      { id: "analises", label: "An\xE1lises", href: "#analises" },
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(mergeProps({
        ...
        role: "banner"
      }, _attrs))}><nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" aria-label="Navega\xE7\xE3o principal"><div class="flex items-center justify-between h-16 lg:h-18"><a href="#" class="flex-shrink-0 group" aria-label="Ir para o topo da p\xE1gina"><span class="text-lg sm:text-xl font-extrabold font-mono tracking-tight text-gold-500 group-hover:text-gold-400 transition-colors duration-200"> World Cup 2026 Intelligence </span></a><div class="hidden lg:flex lg:items-center lg:gap-1"><ul class="flex items-center gap-1"><!--[-->`);
      ...
      _push(`<div class="ml-3 inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-marine-800/80 border border-marine-700/50 text-xs text-gray-400 font-mono" aria-label="Data da \xFAltima atualiza\xE7\xE3o dos dados"><span class="h-1.5 w-1.5 rounded-full bg-green-500 animate-pulse" aria-hidden="true"></span><span>Dados atualizados em 12 de junho de 2026</span></div></div><div class="flex items-center gap-3 lg:hidden">`);
      _push(ssrRenderComponent(_component_ThemeToggle, null, null, _parent));
      _push(`<button type="button" class="inline-flex items-center justify-center p-2 rounded-lg text-gray-300 hover:text-gold-400 hover:bg-marine-800/50 transition-colors duration-200 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold-500"${ssrRenderAttr("aria-expanded", mobileMenuOpen.value)} aria-controls="mobile-menu" aria-label="Abrir menu de navega\xE7\xE3o">`);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<footer${ssrRenderAttrs(mergeProps({
    ...
    role: "contentinfo"
  }, _attrs))}><div class="section-container py-12 lg:py-16"><div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-10"><div class="space-y-4"><p class="text-lg font-extrabold font-mono text-gold-500"> World Cup 2026 Intelligence </p><p class="text-sm text-gray-400 leading-relaxed"> An\xE1lise editorial independente. Dados compilados de fontes p\xFAblicas. Atualizado em 12 de junho de 2026. </p></div><div class="space-y-4"><h3 class="text-sm font-semibold text-gray-300 uppercase tracking-wider"> Navega\xE7\xE3o </h3><ul class="space-y-2"><li><a href="#metodologia" class="text-sm text-gray-400 hover:text-gold-400 transition-colors duration-200 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold-500"> Metodologia </a></li><li><a href="#fontes" class="text-sm text-gray-400 hover:text-gold-400 transition-colors duration-200 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold-500"> Fontes </a></li><li><a href="#ranking" class="text-sm text-gray-400 hover:text-gold-400 transition-colors duration-200 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold-500"> Ranking completo </a></li><li><a href="#resumo" class="text-sm text-gray-400 hover:text-gold-400 transition-colors duration-200 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold-500"> In\xEDcio </a></li></ul></div><div class="space-y-4 sm:col-span-2 lg:col-span-1"><h3 class="text-sm font-semibold text-gray-300 uppercase tracking-wider"> Aviso importante </h3><div class="p-4 rounded-lg border border-gold-500/20 bg-marine-900/60"><p class="text-xs text-gray-400 leading-relaxed"> As probabilidades apresentadas s\xE3o estimativas anal\xEDticas e n\xE3o representam recomenda\xE7\xF5es financeiras ou de aposta. Este \xE9 um projeto editorial independente com fins informativos. </p></div></div></div><div class="mt-12 pt-6 border-t border-marine-800/60 flex flex-col sm:flex-row items-center justify-between gap-3"><p class="text-xs text-gray-500"> \xA9 2026 World Cup 2026 Intelligence. Todos os direitos reservados. </p><p class="text-xs text-gray-600 font-mono"> Edi\xE7\xE3o de 12 de junho de 2026 </p></div></div></footer>`);
}
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<button${ssrRenderAttrs(mergeProps({
        ...
        "aria-label": "Voltar ao topo da p\xE1gina",
...
//# sourceMappingURL=default-BNT-pOng.mjs.map
