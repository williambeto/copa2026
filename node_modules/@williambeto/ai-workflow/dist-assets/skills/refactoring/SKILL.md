---
name: refactoring
description: Skill-backed capability for refactoring work
---

# Refactoring Skill Contract
...
Provide reusable domain guidance for `refactoring` work.
...
Use this skill when the owning primary agent needs domain support related to `refactoring`.
